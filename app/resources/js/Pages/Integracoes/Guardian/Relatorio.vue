                    ...
                    <table class="min-w-full text-sm">
                        <thead class="bg-gray-50 text-gray-500 text-xs uppercase">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-right">Peso doc.</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <tr v-for="t in tickets" :key="t.ticket" class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-xs">{{ t.unidade ?? '—' }}</td>
                                <td class="px-4 py-2 text-gray-600 text-xs">{{ t.atendente ?? '—' }}</td>
                                <td class="px-4 py-2 font-mono text-xs">{{ t.pedido ?? '—' }}</td>
                                <td class="px-4 py-2 text-right font-mono tabular-nums">{{ fmtPeso(t.peso_doc_kg) }}</td>
